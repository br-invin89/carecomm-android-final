...
public class EditEventFrgment extends BaseFragment implements View.OnClickListener {
...
//            inputType = getArguments().getInt(Constants.inputType);
    ...
    protected void inits() {
        ...
        etEventName.setText(txtTitleString);
    ...
    public void onClick(View view) {
        ...
        if (view == btnDelete){
            getMainActivity().ReplaceFragmentWithBackstack(new CalenderFrgment(),false,true);
        }
