...
public class DialVideoCallMobileActivity extends BaseFragmentActivity implements View.OnClickListener, Session.SessionListener, PublisherKit.PublisherListener {
    ...
    private LinearLayout cSubscriber;
    ...
    private void startShowVideoFrames() {
