...
public class RelativeItemAdapter extends RecyclerView.Adapter<RelativeItemAdapter.ItemView> {
    ...
    public RelativeItemAdapter(Context context, List<RelativeModel> dataSet) {
    ...
    public ItemView onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_item_family, viewGroup, false);
        return new ItemView(view);
    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    @Override
    public void onBindViewHolder(@NonNull RelativeItemAdapter.ItemView holder, int position) {
